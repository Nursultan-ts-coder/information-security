...
**Jupyter Notebook** was used for interactive lab documentation and code execution. Install it with:

```bash
pip install jupyter
```

Then open notebooks with:
...
- **Notebooks:** `.ipynb` files can be opened with Jupyter
- **Python Scripts:** Run with `python filename.py`
- **Configuration Files:** View and configure as needed
- **Documentation:** Read `index.md` files in each lab folder for details
